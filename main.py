...
async def main():
    ...
    """
    print("🎓 Welcome to YourTeacher - AI-Powered Personalized Learning System")
    print("=" * 70)
    ...
    while True:
        try:
            with trace("Educational System", group_id=conversation_id):
                ...
                for new_item in result.new_items:
                    ...
                    if isinstance(new_item, MessageOutputItem):
                        ...
                        print(
                            f"\n🔄 Handoff: {new_item.source_agent.name} → {new_item.target_agent.name}")
